...
function drawBuilding(x, y) {
  ...
  // triángulos laterales del techo
  ...
  // ventanas
  drawWindow(x + 50, y + 40, true);
  drawWindow(x + 145, y + 40, false);
  drawWindow(x + 240, y + 40, true);

  drawWindow(x + 50, y + 190, false);
  drawWindow(x + 145, y + 190, false);
  drawWindow(x + 240, y + 190, false);

  drawWindow(x + 50, y + 350, false);
  drawDoor(x + 145, y + 320);
  drawWindow(x + 240, y + 350, false);
}
...
function drawWindow(x, y, blinds) {
...
function drawPole(x) {
  ...
  triangle(x + 30, 410, x, 520, x + 60, 520);
}
